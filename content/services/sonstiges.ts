...
export const sonstiges: ServiceConfig = {
  ...
  leistungen: [
    {
      nummer: "01",
      titel: "Carports & Einstellplätze",
      text: "Planung und Bau von Carports in Holz- oder Stahlkonstruktion. Passend zum Grundstück, witterungsbeständig und mit Baugenehmigung auf Wunsch.",
    },
    {
      nummer: "02",
