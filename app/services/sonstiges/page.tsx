...
const leistungen = [
  { nummer: "01", titel: "Carports & Einstellplätze", text: "Planung und Bau von Carports in Holz- oder Stahlkonstruktion. Passend zum Grundstück, witterungsbeständig und mit Baugenehmigung auf Wunsch." },
  { nummer: "02", titel: "Gartenhäuser & Schutzhütten", text: "Wir besorgen und bauen Gartenhäuser, Geräteschuppen oder individuelle Schutzhütten. Massiv, langlebig, praxisgerecht." },
  { nummer: "03", titel: "Stallungen & Nebengebäude", text: "Einfache Stallbauten und landwirtschaftliche Nebengebäude – solide konstruiert, funktional und ohne unnötige Komplikationen." },
  { nummer: "04", titel: "Winterdienst", text: "Zuverlässiger Räum- und Streudienst für Firmen und Privatkunden. Vertragsbasiert, pünktlich, mit eigenem Maschinenpark." },
];
      ...
      <section className="relative min-h-[60vh] flex items-end overflow-hidden pt-24 pb-16 px-6 md:px-10">
        ...
        <div className="mx-auto max-w-6xl w-full">
          <div className="flex items-center gap-2 mb-10 pl-6">
            ...
            <span className="text-muted/30 text-[0.7rem]">/</span>
            <span className="text-[0.7rem] text-brand-accent uppercase tracking-widest">Sonstige Leistungen</span>
          </div>
          <div ref={hero.ref} className="pl-6 transition-all duration-700"
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <Small className="text-brand-accent uppercase tracking-[0.18em] text-[0.7rem] font-semibold">Leistungsbereich 04</Small>
            </div>
            <H1 className="mb-6 max-w-3xl">
              Sonstige Leistungen.<br />
              <em className="not-italic text-brand-accent">Was das Projekt braucht.</em>
            </H1>
        ...
        <span className="pointer-events-none absolute right-8 bottom-0 font-[family-name:var(--font-serif-display)] text-[20vw] leading-none text-white/[0.03] select-none" aria-hidden>04</span>
      </section>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div ref={warumRef.ref} className="transition-all duration-700"
              ...
              <H2 className="mb-6">Kein Job zu klein.<br />Kein Job zu groß.</H2>
