            ...
            <div className="relative w-full aspect-[16/7] bg-surface overflow-hidden">
                {imageSrc ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-[0.65rem] font-semibold tracking-[0.2em] text-muted/40 uppercase">
                            Bild folgt
                        </span>
                    </div>
                )}
            ...
            <section className="bg-surface py-24 px-4 md:px-10">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 md:flex-shrink-0">
                        <Button variant="primary" href="/contact" className="min-w-[11rem] whitespace-nowrap">
                            ANFRAGE STELLEN
                        </Button>
                        <Button variant="outline" href="tel:+4915234002234" className="min-w-[11rem] whitespace-nowrap">
                            ANRUFEN
                        </Button>
                    </div>
                </div>
