...
const leistungen = [
    { nummer: "01", titel: "Kronenpflege & -sicherung", text: "Totholzentnahme, Schnittmaßnahmen und Kronensicherungssysteme für standsichere, gesunde Bäume. Wir arbeiten nach aktuellen FLL-Richtlinien." },
    { nummer: "02", titel: "Baumfällungen", text: "Fachgerechte Fällungen mit Seiltechnik, Maschinen oder Hebebühne – nach sorgfältiger Begutachtung und unter Einhaltung aller gesetzlichen Vorgaben." },
    { nummer: "03", titel: "Kletterarbeiten", text: "Präzise Eingriffe direkt im Baum, auch in engen Gärten, Innenhöfen oder ohne Zufahrt für Großgeräte. Schonend für die Umgebung." },
    { nummer: "04", titel: "Wurzelstockentfernung", text: "Vollständige Entfernung mit Fräse oder Baggertechnik. Flächen werden danach wieder nutzbar – für Pflanzungen, Rasen oder Pflasterarbeiten." },
    { nummer: "05", titel: "Obstbaumschnitt", text: "Erziehungs-, Erhaltungs- oder Verjüngungsschnitt – individuell abgestimmt auf Baumart, Alter und Standort für maximale Gesundheit und Ertrag." },
    { nummer: "06", titel: "Notfallservice bei Sturmschäden", text: "Schnelle Reaktion nach Unwettern. Wir beseitigen akute Gefahren durch umgestürzte Bäume oder instabile Kronenteile – zuverlässig und ohne Verzug." },
    { nummer: "07", titel: "Rodung & Entbuschung", text: "Flächenhafte Rodung und Entbuschung – auch an Steilhängen mit Raupe und Forstmulcher. Saubere Ergebnisse, effizient ausgeführt." },
    { nummer: "08", titel: "Objektpflege", text: "Regelmäßige Pflege von Außenanlagen für Firmen, Wohnanlagen und öffentliche Auftraggeber. Verlässlich, saisonal und auf Wunsch als Dauerauftrag." },
];

const vorteile = [
    "Ausgebildete Baumkletterer mit Seiltechnik",
    "Moderne Maschinen & Hebebühne",
    "Einhaltung FLL-Richtlinien",
    "Notfallservice 24/7",
    "Festpreisgarantie",
    "Termintreu & verlässlich",
];
...
export default function LandschaftspflegePage() {
            ...
            <section className="relative min-h-[60vh] flex items-end overflow-hidden pt-24 pb-16 px-6 md:px-10">
                ...
                <div className="mx-auto max-w-6xl w-full">
                    <div className="flex items-center gap-2 mb-10 pl-6">
                        ...
                        <span className="text-muted/30 text-[0.7rem]">/</span>
                        <span className="text-[0.7rem] text-brand-accent uppercase tracking-widest">Landschaftspflege</span>
                    </div>
                    <div ref={hero.ref} className="pl-6 transition-all duration-700"
                        ...
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <Small className="text-brand-accent uppercase tracking-[0.18em] text-[0.7rem] font-semibold">Leistungsbereich 01</Small>
                        </div>
                        <H1 className="mb-6 max-w-3xl">
                            Landschafts&shy;pflege.<br />
                            <em className="not-italic text-brand-accent">Professionell. Termintreu.</em>
                        </H1>
                ...
                <span className="pointer-events-none absolute right-8 bottom-0 font-[family-name:var(--font-serif-display)] text-[20vw] leading-none text-white/[0.03] select-none" aria-hidden>01</span>
            </section>
                ...
                <div className="mx-auto max-w-6xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div ref={warumRef.ref} className="transition-all duration-700"
                            ...
                            <H2 className="mb-6">Fachbetrieb.<br />Nicht Hobbyist.</H2>
