...
export function ServiceCta({ config }: { config: ServiceConfig }) {
  ...
  return (
    <section className="bg-brand-primary py-24 md:py-28 px-4 md:px-10">
      <div
        ref={ref}
      ...
      >
        ...
        {/* Headline */}
        <H2 className="text-white mb-3 max-w-xl">
          Interesse an{" "}
          <span className="text-brand-accent">{config.breadcrumbLabel}?</span>
        </H2>
        <p className="text-white/50 text-sm mb-12 max-w-md leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-white/10">
          ...
          <a
            ...
            className="group flex flex-col gap-3 bg-brand-primary p-7 hover:bg-white/5 transition-colors duration-200"
          >
            <span className="text-[0.65rem] font-semibold tracking-[0.2em] text-brand-accent uppercase">
              01 — Anrufen
            </span>
            <span className="text-lg font-semibold text-white group-hover:text-brand-accent transition-colors duration-200">
              +49 152 34002234
            </span>
            <span className="text-xs text-white/40">Mo–Fr, 07:00–18:00 Uhr</span>
          ...
          >
            ...
            <span className="text-xs text-white/40">Antwort meist innerhalb 24 h</span>
            <span className="mt-auto text-brand-accent text-sm transition-transform duration-300 group-hover:translate-x-1">→</span>
          </a>
          ...
          >
            ...
            <span className="text-xs text-white/40">Unverbindlich & kostenlos</span>
            <span className="mt-auto text-brand-accent text-sm transition-transform duration-300 group-hover:translate-x-1">→</span>
          </Link>
